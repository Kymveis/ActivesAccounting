// === CETITEC GmbH =================================================================
// 
//  File:      AddCurrencyWindow.xaml.cs
// 
...
{
    public AddCurrencyWindow(ICurrenciesContainer aCurrenciesContainer)
    {
        InitializeComponent();
        DataContext = new AddCurrencyViewModel(
            aCurrenciesContainer, Close, aC => NewCurrency = aC);
    }

    public ICurrency? NewCurrency { get; private set; }
}